...
contract TokenExchange is Ownable {
    string public exchange_name = "SmartSwap";
    ...
    function removeLiquidity(
        ...
        // Ensure exchange rate falls between provided parameters
        ...
        // Update the exchange state
        lps[msg.sender] =
            ((lps[msg.sender] * oldReserves) - amountTokens * denominationVal) / token_reserves;
