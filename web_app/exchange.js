...
const exchange_name = 'SmartSwap';             // TODO: fill in the name of your exchange

const token_name = 'dpCoin';                // TODO: replace with name of your token
const token_symbol = 'DPN';              // TODO: replace with symbol for your token
...
async function init() {
    ...
    if (poolState['token_liquidity'] === 0
      ...
      await exchange_contract.connect(provider.getSigner(defaultAccount)).createPool(1000, { value: ethers.utils.parseUnits("1000", "wei")});
